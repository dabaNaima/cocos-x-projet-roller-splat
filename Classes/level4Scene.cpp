...
bool level4::init()
{
    ...
    auto label = Label::createWithTTF(" level 4 ", "fonts/Marker Felt.ttf", 24);
    ...
    auto balsprite = Sprite::create("ballon4.png");

    problemLoading("'ballon4.png'");

    // position the sprite on the center of the screen
    balsprite->setPosition(Vec2(100, 339));
    ...
    drawNode->drawPoint(Vec2(98, 339), 62.0f, Color4F::RED);
...
//code for us Handling Keyboard Events
    ...
    eventListener->onKeyPressed = [](EventKeyboard::KeyCode keyCode, Event* event) {
        ...
        case EventKeyboard::KeyCode::KEY_A:
            ...
            if (loc.x == 480 && loc.y == 339) {
                event->getCurrentTarget()->setPosition(loc.x -= 70, loc.y);
        ...
        case EventKeyboard::KeyCode::KEY_D:
            ...
            if (loc.x == 100 && loc.y == 81) {
                event->getCurrentTarget()->setPosition(loc.x += 125, loc.y);
            ...
            if (loc.x == 350 && loc.y == 81) {
                event->getCurrentTarget()->setPosition(loc.x += 130, loc.y);
        ...
        case EventKeyboard::KeyCode::KEY_W:
            if (loc.x == 225 && loc.y == 81) {
                event->getCurrentTarget()->setPosition(loc.x, loc.y += 192);
            ...
            if (loc.x == 480 && loc.y == 81) {
                event->getCurrentTarget()->setPosition(loc.x, loc.y += 258);
